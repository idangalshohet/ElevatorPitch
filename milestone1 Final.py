...
#     reading = accel_data['z'] - 9.81
#     frequency = reading * 100
...
#         plt.show()
    ...
    # write code that automatically turn the whole thing off 
        ...
        # plt.plot(accel_log, color = 'r', label = 'acceleration')
        # plt.plot(vel_log, color = 'b', label = 'velocity')
        # # plt.plot(superaverage, color = 'y', label = 'velocity')
        # plt.ylim([-0.25,0.25])
